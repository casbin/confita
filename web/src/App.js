    ...
    return (
      <div>
        ...
        <Switch>
          ...
          <Route exact path="/conference" render={(props) => <Conference account={this.state.account} {...props} />} />
          <Route path="/conference/:conferenceName" render={(props) => <Conference account={this.state.account} {...props} />} />
